...
type MutationsResolver interface {
	...
	ChangeUserRoles(ctx context.Context, username string, roles []string) (bool, error)
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutations.changeUserRoles":
		if e.complexity.Mutations.ChangeUserRoles == nil {
			break
		}

		args, err := ec.field_Mutations_changeUserRoles_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Mutations.ChangeUserRoles(childComplexity, args["username"].(string), args["roles"].([]string)), true
...
func (ec *executionContext) field_Mutations_changeUserRoles_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 string
	if tmp, ok := rawArgs["username"]; ok {
...
func (ec *executionContext) _Mutations_changeUserRoles(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	rawArgs := field.ArgumentMap(ec.Variables)
	args, err := ec.field_Mutations_changeUserRoles_args(ctx, rawArgs)
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	}
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		directive0 := func(rctx context.Context) (interface{}, error) {
			ctx = rctx // use context from middleware stack in children
			return ec.resolvers.Mutations().ChangeUserRoles(rctx, args["username"].(string), args["roles"].([]string))
		}
		directive1 := func(ctx context.Context) (interface{}, error) {
			role, err := ec.unmarshalNRole2githubᚗcomᚋatahaniᚋetcdᚑdashboardᚋapiᚋgraphᚋmodelᚐRole(ctx, "ROOT")
			if err != nil {
...
func (ec *executionContext) _Mutations(ctx context.Context, sel ast.SelectionSet) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "changeUserRoles":
			out.Values[i] = ec._Mutations_changeUserRoles(ctx, field)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		case "addUser":
